...
// const box6 = document.querySelector("#section6 .imgbox");
// gsap.to(box6,{
//   duration: 100,
//   x: 100,
//   scale: 1.05,
...
//       end: "bottom top",
//       scrub: true,
//       //toggleClass: "active", // active 클래스 토글시킴
//       markers: true,
//       id: "box6"
//   }
// });
...
gsap.utils.toArray(".parallax .imgbox").forEach((item, index) => {
  ...
  // .section7에 있는 .imgbox는 x: -100으로 움직이도록 설정
  if (index === 1) {
...
gsap.to(section9Text, {
  scrollTrigger: {
    trigger: "#section9",
    start: "top top", // 트리거 요소의 상단이 스크린 중앙에 도달하면 시작
    end: "bottom center", // 트리거 요소의 하단이 스크린 중앙에 도달하면 종료
...
// 타이핑할 문장
var result  = "도전을 즐기며 코드에 강렬한 희망을 심겠습니다.<br>ka604@naver.com";
var typeing1=[];
